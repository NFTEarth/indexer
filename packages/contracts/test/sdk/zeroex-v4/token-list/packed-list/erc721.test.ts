...
import * as ZeroexV4 from "@nftearth/sdk/src/zeroex-v4";
...
describe("ZeroEx V4 - PackedList TokenList Erc721", () => {
  ...
  it("Build and fill buy order", async () => {
    ...
    const builder = new ZeroexV4.Builders.TokenList.PackedList(chainId);
